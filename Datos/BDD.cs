...
namespace Datos
{
    public class BDD 
    {
        ...
        public BDD()
        {
            servidorBDD = ConfigurationManager.AppSettings["servidorBDD"];
            nombreBDD = ConfigurationManager.AppSettings["nombreBDD"];
            usuario = ConfigurationManager.AppSettings["usuarioBDD"];
            password = ConfigurationManager.AppSettings["passwordBDD"];
            gestorBDD = ConfigurationManager.AppSettings["gestorBDD"];
            puertoBDD = ConfigurationManager.AppSettings["puertoBDD"];
            sslModeBDD = ConfigurationManager.AppSettings["sslModeBDD"];
            serviceNameBDD = ConfigurationManager.AppSettings["serviceNameBDD"];
